...
extern int g_os_timer_resume_type;
...
/*    _tx_timer_activate                Timer reactivate processing       */ 
/*                                                                        */ 
/*  CALLED BY                                                             */ 
/*                                                                        */ 
/*    ThreadX Scheduler                                                   */ 
...
/*  03-01-1998     William E. Lamie         Moved the reactivate timer    */ 
...
/*                                            call to timer activate to   */ 
/*                                            reduce code size, resulting */ 
/*                                            in version 4.0.             */ 
/*  07-15-2002     William E. Lamie         Modified comment(s) and       */ 
/*                                            changed constant TX_FOREVER */ 
/*                                            to TX_LOOP_FOREVER,         */ 
...
ULONG                       timeout_param;              /* Local timeout parameter      */
    ...
    do
    {
        ...
        *_tx_timer_current_ptr =  TX_NULL;
...
#ifndef OS_ABS_TIMER_DISABLE
		/* if the timer is a absolute timer, don't move the _tx_timer_current_ptr */
		if(g_os_timer_resume_type == OS_TIMER_RESUME_TYPE_TICK)
		{
#endif //OS_ABS_TIMER_DISABLE
        ...
        {
#ifndef OS_ABS_TIMER_DISABLE
			/* if the timer is resumed by RTC interrupt, and it is a relative timer, do nothing. */
			if(expired_timers->os_timer_type == OS_TIMER_TYPE_REL 
				&& g_os_timer_resume_type == OS_TIMER_RESUME_TYPE_RTC)
			{
				if(*_tx_timer_current_ptr == TX_NULL)
					*_tx_timer_current_ptr = expired_timers;
				expired_timers = expired_timers-> tx_active_next;
				if(expired_timers == *_tx_timer_current_ptr)
					break;
				continue;
			}
#endif //OS_ABS_TIMER_DISABLE
...
#ifndef OS_ABS_TIMER_DISABLE
		/* set the timer resume type to default type */
		g_os_timer_resume_type = OS_TIMER_RESUME_TYPE_TICK;
#endif //OS_ABS_TIMER_DISABLE

...
/* define the timer types */
#define OS_TIMER_TYPE_REL				0
#define OS_TIMER_TYPE_ABS				1
/* define the timer resume types */
#define OS_TIMER_RESUME_TYPE_TICK		0
#define OS_TIMER_RESUME_TYPE_RTC		1
...
typedef  struct TX_THREAD_STRUCT
{
    ...
    /*the follow structure defined for filesystem*/
#ifdef OS_FEA_FILE_SYSTEM_SWITCH
    void *dir_path_ptr;  
    ULONG pt_errno;                     /* error no                 */
